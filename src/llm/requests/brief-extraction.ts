  ...
  return {
    ...
    properties: {
      ...
      cards: {
        type: 'array',
        description:
          'Kortene i prioriteret rækkefølge, vigtigst først; de sidste foldes sammen, hvis der er flere end siden viser. 5–10 en normal morgen. Hvert kort er én selvstændig ting, forælderen skal vide eller gøre; handlinger, der kan klares hver for sig, er separate kort.',
        items: {
          type: 'object',
          properties: {
            title: {
