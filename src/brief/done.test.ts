...
const SOURCE = sourceItem({
  ...
  childNames: ['Halfdan Eksempelsen'],
...
const SIGNAL: RankedSignal = {
  id: 'model:0',
  kind: 'action',
  title: 'Tilmeld Halfdan til skolefoto inden mandag',
  child: 'Halfdan',
  dueAt: '2026-08-17',
  urgency: 'now',
...
describe('doneKeys', () => {
  test('survives the composer rewording the card', () => {
    ...
    const reworded: RankedSignal = { ...SIGNAL, id: 'model:4', title: 'Skolefoto: tilmeld Halfdan', kind: 'deadline' };
