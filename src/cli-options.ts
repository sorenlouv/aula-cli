...
const COMMAND_OPTIONS = {
  ...
  widgets: [...TEXT, ...CACHED],
  ugeplan: [...TEXT, ...CACHED, 'week', 'next', 'child', 'widget', 'from', 'to'],
  ugebrev: [...TEXT, ...CACHED, 'week', 'next', 'child', 'widget', 'from', 'to'],
  opgaver: [...TEXT, ...CACHED, 'week', 'next', 'child', 'widget', 'from', 'to'],
  lektier: [...TEXT, ...CACHED, 'week', 'next', 'child', 'widget', 'from', 'to'],
  huskelisten: [...TEXT, ...CACHED, 'week', 'next', 'child', 'widget', 'from', 'to'],
